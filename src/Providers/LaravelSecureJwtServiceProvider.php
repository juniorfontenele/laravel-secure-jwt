...
class LaravelSecureJwtServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->singleton(JwtDriverInterface::class, FirebaseJwtDriver::class);
        $this->app->singleton(JwtBlacklistRepositoryInterface::class, LaravelCacheBlacklistRepository::class);
        $this->app->singleton(JwtNonceRepositoryInterface::class, LaravelCacheNonceRepository::class);
        $this->app->singleton(JwtClaimValidatorInterface::class, JwtClaimValidator::class);
    }
